    ...
    return (
        ...
        <div class="w-96 border-t-8 border-red-600 flex">
          ...
          <div class="w-full pt-9 pr-4">
            <h3 class="font-bold text-red-700">Delete Batch?</h3>
            <p class="py-4 text-sm text-gray-400">Are you sure you want to delete this Batch? If you delete this Batch, you will permantly delete Batch details.</p>
          </div>
        </div>
        ...
        <div class="p-4 flex space-x-4">
          ...
          <a href="#" class="w-1/2 px-4 py-3 text-center text-pink-100 bg-red-600 rounded-lg hover:bg-red-700 hover:text-white font-bold text-sm">Delete Batch</a>
        </div>
      </div>
    )
}
